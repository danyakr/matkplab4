"""
Модуль: Базовая 2D-игра на Pygame

Описание:
Этот модуль реализует простую 2D-игру, где игрок управляет квадратным персонажем,
который может перемещаться внутри окна и взаимодействовать с неподвижными объектами.

Функционал:
- Управление персонажем с помощью клавиш-стрелок.
- Ограничение движения персонажа границами окна.
- Обработка столкновений с неподвижными объектами.
"""
